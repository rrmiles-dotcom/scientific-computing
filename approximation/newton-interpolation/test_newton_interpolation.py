...
def test_constant_interpolation():
    x_values = np.array([2.0])
    y_values = np.array([7.0])
...
def test_matches_known_cubic_polynomial():
    x_values = np.array([
        -2.0,
        -1.0,
        1.0,
...
def test_does_not_modify_y_values():
    x_values = np.array([
        0.0,
        1.0,
        2.0,
...
def test_rejects_non_vector_values():
    x_values = np.ones(4)
    y_values = np.ones((2, 2))
